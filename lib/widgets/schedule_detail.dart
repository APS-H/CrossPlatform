...
class _ScheduleDetailOrderPlanTableState
  ...
  Widget build(BuildContext context) {
    return Container(child: Text('Schedule Detail Order Plan Table'));
  }
}
...
class _ScheduleDetailOrderProductionTableState
  ...
  @override
  Widget build(BuildContext context) {
    return Container(child: Text('Schedule Detail Order Production Table'));
  }
}
...
class _ScheduleDetailProductionTableState
  ...
  @override
  Widget build(BuildContext context) {
    return Container(child: Text('Schedule Detail Production Table'));
  }
}
...
class _ScheduleDetailProductionResourceTableState
  ...
  @override
  Widget build(BuildContext context) {
    return Container(child: Text('Schedule Detail Production Resource Table'));
  }
}

...
final List<ResourceLoad> resources = <ResourceLoad>[
  ResourceLoad('10组-陈  云（5）', ResourceType.humanResource,
      [15, 6.0, 24, 4.0, 87, 14, 1]),
  ResourceLoad('11组-张  娟（4）', ResourceType.humanResource,
      [23, 9.0, 37, 4.3, 19, 8, 1]),
  ResourceLoad(
      '12组-姚兰（5）', ResourceType.humanResource, [26, 16.0, 24, 6.0, 37, 6, 7]),
  ResourceLoad(
      '13组-刘燕（3）', ResourceType.humanResource, [35, 3.7, 67, 4.3, 43, 3, 8]),
  ResourceLoad('14组-周  清（4）', ResourceType.humanResource,
      [36, 16.0, 49, 3.9, 37, 7, 16]),
  ResourceLoad(
      'line01', ResourceType.equipmentResource, [35, 0.0, 94, 0.0, 50, 0, 0]),
  ResourceLoad(
      'line02', ResourceType.equipmentResource, [32, 0.2, 98, 0.0, 38, 0, 2]),
  ResourceLoad(
      'line03', ResourceType.equipmentResource, [48, 3.2, 87, 6.5, 52, 0, 45]),
  ResourceLoad(
      'line04', ResourceType.equipmentResource, [42, 25.0, 51, 4.9, 36, 2, 22]),
  ResourceLoad(
      'line05', ResourceType.equipmentResource, [58, 26.0, 65, 7.0, 54, 12, 6]),
  ResourceLoad('line06', ResourceType.equipmentResource,
      [18, 6.0, 26, 4.0, 87, 14, 1]),
];
